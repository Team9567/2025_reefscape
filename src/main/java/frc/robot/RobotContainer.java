...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    if (m_coralRoller != null) {
      ...
      m_controllerController.button(ButtonConstants.kButtonY).whileTrue(m_coralRoller.runRoller(m_coralRoller, () -> RollerConstants.ROLLER_REVERSE_VALUE, () -> RollerConstants.ROLLER_REVERSE_VALUE2));
    }
/*
